package com.azrinurvani.newsappwithstartedpage.presentation.onboarding.component
...
import com.azrinurvani.newsappwithstartedpage.presentation.onboarding.Page
import com.azrinurvani.newsappwithstartedpage.presentation.onboarding.pages
...
fun OnBoardingPage(
    ...
    Column(
        ...
        Image(
            modifier = Modifier
                .fillMaxWidth()
                .fillMaxHeight(fraction = 0.6f), //60% height
